...
# plt.figure()
# plt.plot(df_theta["theta"], df_theta["e1"], label="e1*")
# plt.plot(df_theta["theta"], df_theta["e2"], label="e2*")
# plt.xlabel(r"$\theta$")
# plt.ylabel("Effort")
# plt.legend()
# plt.title("Effort response to warm-glow preference θ (baseline model)")
# plt.tight_layout()
# plt.show()

# # Baseline parameter values (adjust if you want)
# p0 = BaselineParams(
#     a=1.0, b=1.0,
#     kappa_e=1.0, kappa_mu=1.0, alpha=0.5,
#     delta=0.9, rho=0.3, theta=1.0,
...
# plt.xlabel(r"$\theta$")
# plt.ylabel("Effort")
# plt.title("Effort vs. warm-glow parameter θ")
# plt.legend()
# plt.tight_layout()
# plt.show()

# plt.figure()
# plt.plot(df_theta["theta"], df_theta["mu1"], label="μ1*")
# plt.plot(df_theta["theta"], df_theta["mu2"], label="μ2*")
# plt.xlabel(r"$\theta$")
# plt.ylabel("Manipulation")
# plt.title("Manipulation vs. warm-glow parameter θ")
# plt.legend()
# plt.tight_layout()
# plt.show()

# plt.figure()
# plt.plot(df_theta["theta"], df_theta["psi1"], label="ψ1*")
# plt.plot(df_theta["theta"], df_theta["psi2"], label="ψ2*")
# plt.xlabel(r"$\theta$")
# plt.ylabel(r"SLB intensity $\psi_t$")
# plt.title("Optimal SLB intensities vs. θ")
# plt.legend()
# plt.tight_layout()
# plt.show()
...
# Sub-optimal contracts 1

# # --- 1. Compute optimal results (your existing solver) ---
# p0 = BaselineParams()  # or set your baseline parameters here
# optimal = solve_baseline_model(p0)

# psi1_opt = optimal["psi1"]
# psi2_opt = optimal["psi2"]

# UB_opt = optimal["UB_total"]
# UL_opt = optimal["UL"]

# print("Optimal ψ1 =", psi1_opt)
# print("Optimal ψ2 =", psi2_opt)
# print("Optimal borrower utility =", UB_opt)
# print("Optimal lender utility   =", UL_opt)

# def evaluate_with_given_psi(psi1, psi2, p: BaselineParams):
#     """
#     Computes utilities when the lender uses sub-optimal ψ1,ψ2.
#     Borrower responds optimally (best response).
#     """

#     # Step 1: Borrower best-responds to the GIVEN ψ1, ψ2
#     e1, e2, mu1, mu2 = borrower_optimal_e_mu(psi1, psi2, p)

#     # Step 2: Green signals
#     g1 = green_signal(e1, mu1, p)
#     g2 = green_signal(e2, mu2, p)

#     # Step 3: Compute repayments
#     D1_star = D1(e1, mu1, psi1, p)
#     D2_star = D2(e1, mu1, e2, mu2, psi1, psi2, p)
...
# # --- Create a grid of suboptimal ψ-values ---
# grid_size = 31
# psi1_grid = np.linspace(psi1_opt - 0.3, psi1_opt + 0.3, grid_size)
# psi2_grid = np.linspace(psi2_opt - 0.3, psi2_opt + 0.3, grid_size)

# results = []

# for psi1 in psi1_grid:
#     for psi2 in psi2_grid:
#         res = evaluate_with_given_psi(psi1, psi2, p0)
#         results.append({
#             "psi1": psi1,
#             "psi2": psi2,
#             "UB": res["UB_total"],
#             "UL": res["UL"],
#             "UB_loss": UB_opt - res["UB_total"],   # difference from optimum
#             "UL_loss": UL_opt - res["UL"],         # difference from optimum
#         })

# df = pd.DataFrame(results)

# pivot = df.pivot_table(index="psi1", columns="psi2", values="UB_loss")

# plt.figure(figsize=(7,5))
# plt.contourf(pivot.columns, pivot.index, pivot.values, levels=30, cmap="viridis")
# plt.colorbar(label="Borrower utility loss")
# plt.scatter([psi2_opt],[psi1_opt],color="red",label="Optimum")
# plt.xlabel("ψ2")
# plt.ylabel("ψ1")
# plt.title("Borrower utility loss from suboptimal SLB intensities")
# plt.legend()
# plt.tight_layout()
# plt.show()

# pivot2 = df.pivot_table(index="psi1", columns="psi2", values="UL_loss")

# plt.figure(figsize=(7,5))
# plt.contourf(pivot2.columns, pivot2.index, pivot2.values, levels=30, cmap="viridis")
# plt.colorbar(label="Lender utility loss")
# plt.scatter([psi2_opt],[psi1_opt],color="red",label="Optimum")
# plt.xlabel("ψ2")
# plt.ylabel("ψ1")
# plt.title("Lender utility loss from suboptimal SLB intensities")
# plt.legend()
# plt.tight_layout()
# plt.show()
